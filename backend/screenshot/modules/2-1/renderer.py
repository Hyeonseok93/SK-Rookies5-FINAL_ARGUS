"""Render a deterministic 1280x720 evidence overlay for 2-1 upload findings."""
...
<div id="argus-evidence-bottom">
  <div id="argus-evidence-tabs"><b>ARGUS 2-1 Malicious Upload Evidence</b> {_esc(case.finding_id)}</div>
...
def render_burp_only(case: EvidenceCase) -> tuple[str, str]:
    """Full evidence screenshot focused on the malicious upload request/response."""
