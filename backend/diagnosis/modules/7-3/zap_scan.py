...
def run_zap_phase(
    ...
    *,
    ...
    scan_cfg = raw_config.get("diagnosis_7_3") or raw_config.get("scan_7_3") or {}
    ...
    try:
        stats["workspace_reset_before"] = reset_zap_workspace(zap, session_name="argus-g73-start")
        apply_auth_to_zap(zap, auth)
        configure_73_scanners(zap)
        ...
        findings = collect_zap_header_findings(zap, base_urls)
        stats.update(
            {
                "seeded": seeded,
                "seed_cap": seed_cap,
        ...
        try:
            stats["workspace_reset_after"] = reset_zap_workspace(zap, session_name="argus-g73-done")
